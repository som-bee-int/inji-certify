...
VALUES ('https://www.w3.org/2018/credentials/v1', 'EmploymentCredential,VerifiableCredential', '{
     "@context": [
         "https://www.w3.org/2018/credentials/v1",
         "https://som-bee.github.io/DID/employment-letter.json",
         "https://w3id.org/security/suites/ed25519-2020/v1"
     ],
     "issuer": "${_issuer}",
     "type": [
     ...
     "credentialSubject": {
         ...
         "employerRegId": "${employerRegId}",
         "employerContactName": "${employerContactName}",
         "employerContactNumber": "${employerContactNumber}",
...
', '2024-01-13 12:32:38.065994', NULL);


INSERT INTO certify.credential_template (context, credential_type, template, cr_dtimes, upd_dtimes) VALUES ('https://www.w3.org/2018/credentials/v1', 'TechnicianCredential,VerifiableCredential', '{
     "@context": [
         "https://www.w3.org/2018/credentials/v1",
         "https://som-bee.github.io/DID/technician.json",
         "https://w3id.org/security/suites/ed25519-2020/v1"
     ],
     "issuer": "${_issuer}",
     "type": [
...
INSERT INTO certify.credential_template (context, credential_type, template, cr_dtimes, upd_dtimes) VALUES ('https://www.w3.org/2018/credentials/v1', 'StudentAccomplishmentCredential,VerifiableCredential', '{
     "@context": [
         "https://www.w3.org/2018/credentials/v1",
         "https://som-bee.github.io/DID/student-achievement.json",
         "https://w3id.org/security/suites/ed25519-2020/v1"
     ],
     "issuer": "${_issuer}",
     "type": [
         "VerifiableCredential",
         "StudentAccomplishmentCredential"
     ],
     "issuanceDate": "${validFrom}",
     "expirationDate": "${validUntil}",
     "credentialSubject": {
         ...
         "placementSecured": "${placementSecured}",
         "clubName": "${clubName}",
         "comments": "${comments}",
         "studentID": "${studentID}",
         "photo": "${photo}"
